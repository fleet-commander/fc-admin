...
PARSED_BOOKMARKS_DATA = [
    json.dumps([["Bookmarks bar", "Fedora"], "8", "https://getfedora.org/", "Get Fedora"], sort_keys=True),
    json.dumps([["Bookmarks bar", "Fedora"], "5", "https://start.fedoraproject.org/", "Fedora Project"], sort_keys=True),
    json.dumps([["Bookmarks bar"], "10", "https://www.chromium.org/", "The Chromium Projects"], sort_keys=True),
    json.dumps([["Bookmarks bar"], "11", "http://fleet-commander.org/", "Fleet Commander"], sort_keys=True),
    json.dumps([["Other bookmarks"], "12", "https://github.com/fleet-commander/", "Fleet Commander Github"], sort_keys=True)
]

DIFFERENCE_BOOKMARKS_DATA = [
    json.dumps([["Bookmarks bar","Fedora"], "8", "https://getfedora.org/", "Get Fedora NOW!!!"], sort_keys=True),
    json.dumps([["Bookmarks bar","Fedora"], "10", "https://www.chromium.org/", "The Chromium Projects"], sort_keys=True),
    json.dumps([["Bookmarks bar","Fedora"], "14", "pagure.org/SSSD", "SSSD"], sort_keys=True),
    json.dumps([["Bookmarks bar"], "11", "http://fleet-commander.org/documentation.html", "Fleet Commander Docs"], sort_keys=True),
    json.dumps([["Bookmarks bar"], "13", "http://freeipa.org", "FreeIPA"], sort_keys=True),
]
...
class TestChromiumLogger(unittest.TestCase):
    ...
    def test_07_preferences_monitoring(self):
        ...
        self.assertEqual(
            json.dumps([chromium_logger.namespace,
                {'key': 'BookmarkBarEnabled', 'value': True}], sort_keys=True),
            received)
        ...
        self.assertEqual(
            json.dumps([chromium_logger.namespace,
                { 'key': 'ShowHomeButton', 'value': False }], sort_keys=True),
            received)
    ...
    def test_08_bookmarks_monitoring(self):
        ...
        self.assertEqual(
            json.dumps([chromium_logger.namespace,
                { "key": 'ManagedBookmarks', "value": multisession}], sort_keys=True),
            received)
