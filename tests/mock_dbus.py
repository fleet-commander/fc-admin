...
bus.add_signal_receiver(ml.quit, signal_name='Disconnected',
                        path='/org/freedesktop/DBus/Local',
                        dbus_interface='org.freedesktop.DBus.Local')


fdo_bus = dbus.service.BusName("org.freedesktop.ScreenSaver",
                               bus,
...
dconf_bus = dbus.service.BusName("ca.desrt.dconf",
                                 bus,
                                 allow_replacement=True,
                                 replace_existing=True,
                                 do_not_queue=True)

dconf = dbusmock.mockobject.DBusMockObject(dconf_bus,
